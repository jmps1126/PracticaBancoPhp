	...
	<body background="img/fondo.jpg">
		<nav class="nav-gris padding-largo text-center">
			<ul class="no-lista">
				...
				<li class="col-md-6 inline-block"><a href="principal.php" class="pacifico ">Solicitud Crédito</a></li>
			</ul>
		</nav>
